...
Solution Approach
We are going to try different combination by including an item in our set or not including in our set. For example if we select item 1 what's the weight and profit
and if we don't include it what's the weight and profit.
