...
Solution Approach
We are going to try different combination by including an item in our set or not including in our set. For example if we select item #1, we would calculate the weight and profit
and another combination when we don't include it.
